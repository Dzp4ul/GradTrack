...
CREATE TABLE `admin_users` (
    ...
    `role` ENUM('mis_staff','research_coordinator','registrar','alumni_president','dean_cs','dean_coed','dean_hm') NOT NULL DEFAULT 'research_coordinator',
...
CREATE TABLE `graduate_accounts` (
    ...
    `status` ENUM('pending_verification','active','inactive','rejected','disabled') NOT NULL DEFAULT 'pending_verification',
