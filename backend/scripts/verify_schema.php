...
$requirements = [
    ...
    'forum_chat_members' => ['id', 'room_id', 'graduate_id', 'last_read_at', 'last_read_message_id', 'hidden_at', 'hidden_before_message_id'],
    ...
    'job_posts' => ['id', 'posted_by_account_id', 'created_by_admin_id', 'title', 'salary_range', 'course_program_fit', 'contact_email', 'application_link', 'requirements_file_path'],
    ...
    'mentorship_messages' => ['id', 'mentorship_request_id', 'sender_account_id', 'message_text'],
