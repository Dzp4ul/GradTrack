...
if (!function_exists('gradtrack_alumni_registry_summary_data')) {
    /**
     * Shared source of truth for the Alumni Registered List cards and GenAI tools.
     */
    function gradtrack_alumni_registry_summary_data(PDO $db): array
    {
