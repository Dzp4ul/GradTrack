    ...
    $templates = [
        'graduate_tracer' => [
            ...
            'questions' => [
                ...
                ['question_text' => '1. Name Extension', 'question_type' => 'multiple_choice', 'options' => ['Jr.', 'Sr.', 'II', 'III', 'IV', 'V', 'VI'], 'is_required' => 0, 'sort_order' => 4],
                ...
                ['question_text' => '3. E-mail Address', 'question_type' => 'text', 'options' => null, 'is_required' => 1, 'sort_order' => 6],
                ['question_text' => '4. Mobile Number', 'question_type' => 'text', 'options' => null, 'is_required' => 1, 'sort_order' => 7],
                ['question_text' => '5. Civil Status', 'question_type' => 'multiple_choice', 'options' => ['Single', 'Married', 'Widowed', 'Separated'], 'is_required' => 1, 'sort_order' => 8],
                ['question_text' => '6. Sex', 'question_type' => 'multiple_choice', 'options' => ['Male', 'Female'], 'is_required' => 1, 'sort_order' => 9],
                ...
                ['question_text' => '8. Year Graduated', 'question_type' => 'text', 'options' => null, 'is_required' => 1, 'sort_order' => 11],
                ['question_text' => '9. Honors / Awards Received', 'question_type' => 'checkbox', 'options' => ['Cum Laude', 'Magna Cum Laude', 'Leadership Award', 'Best in Thesis', "Dean's Lister", 'Academic Excellence'], 'is_required' => 0, 'sort_order' => 12],
                
                // Section C - Employment Data
                ['question_text' => '10. Are you presently employed?', 'question_type' => 'multiple_choice', 'options' => ['Yes', 'No'], 'is_required' => 1, 'sort_order' => 13],
                ['question_text' => '11. If NO, reason(s) why you are not yet employed', 'question_type' => 'checkbox', 'options' => ['Advance or further study', 'Family concern', 'Health-related reason', 'Lack of work experience', 'No job opportunity', 'Did not look for a job'], 'is_required' => 0, 'sort_order' => 14],
                ['question_text' => '12. If YES, present employment status', 'question_type' => 'multiple_choice', 'options' => ['Regular/Permanent', 'Temporary', 'Casual', 'Contractual', 'Self-employed'], 'is_required' => 0, 'sort_order' => 15],
                ['question_text' => '13. Current position/designation', 'question_type' => 'text', 'options' => null, 'is_required' => 0, 'sort_order' => 16],
                ['question_text' => '14. Company/Organization name', 'question_type' => 'text', 'options' => null, 'is_required' => 0, 'sort_order' => 17],
                ['question_text' => '15. Industry/Sector', 'question_type' => 'multiple_choice', 'options' => ['IT/Technology', 'Education', 'Hospitality', 'Healthcare', 'Government', 'Business/Finance', 'Manufacturing', 'Other'], 'is_required' => 0, 'sort_order' => 18],
                ['question_text' => '16. Monthly salary range', 'question_type' => 'multiple_choice', 'options' => ['Below 10,000', '10,000-20,000', '20,000-30,000', '30,000-50,000', 'Above 50,000'], 'is_required' => 0, 'sort_order' => 19],
                ['question_text' => '17. How long did it take to find your first job?', 'question_type' => 'multiple_choice', 'options' => ['Less than 1 month', '1-3 months', '3-6 months', '6-12 months', 'More than 1 year'], 'is_required' => 0, 'sort_order' => 20],
                ['question_text' => '18. Is your current job related to your course?', 'question_type' => 'multiple_choice', 'options' => ['Yes, directly related', 'Partially related', 'Not related'], 'is_required' => 0, 'sort_order' => 21],
                ['question_text' => '19. Suggestions to improve the course curriculum', 'question_type' => 'text', 'options' => null, 'is_required' => 0, 'sort_order' => 22],
            ]
        ],
        'course_satisfaction' => [
            'id' => 'course_satisfaction',
