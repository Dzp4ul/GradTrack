    ...
    $templates = [
        'graduate_tracer' => [
            ...
            'questions' => [
                ...
                ['question_text' => '2. Region', 'question_type' => 'text', 'options' => null, 'is_required' => 1, 'sort_order' => 5],
                ['question_text' => '3. Province', 'question_type' => 'text', 'options' => null, 'is_required' => 1, 'sort_order' => 6],
                ['question_text' => '4. City/Municipality', 'question_type' => 'text', 'options' => null, 'is_required' => 1, 'sort_order' => 7],
                ['question_text' => '5. Barangay', 'question_type' => 'text', 'options' => null, 'is_required' => 1, 'sort_order' => 8],
                ['question_text' => '6. E-mail Address', 'question_type' => 'text', 'options' => null, 'is_required' => 1, 'sort_order' => 9],
                ['question_text' => '7. Mobile Number', 'question_type' => 'text', 'options' => null, 'is_required' => 1, 'sort_order' => 10],
                ['question_text' => '8. Civil Status', 'question_type' => 'multiple_choice', 'options' => ['Single', 'Married', 'Widowed', 'Separated'], 'is_required' => 1, 'sort_order' => 11],
                ...
                ['question_text' => '13. Are you presently employed?', 'question_type' => 'multiple_choice', 'options' => ['Yes', 'No'], 'is_required' => 1, 'sort_order' => 16],
                ['question_text' => '14. If NO, reason(s) why you are not yet employed', 'question_type' => 'checkbox', 'options' => ['Advance or further study', 'Family concern', 'Health-related reason', 'Lack of work experience', 'No job opportunity', 'Did not look for a job', 'Other:'], 'is_required' => 0, 'sort_order' => 17],
                ['question_text' => '15. If YES, present employment status', 'question_type' => 'multiple_choice', 'options' => ['Regular/Permanent', 'Temporary', 'Casual', 'Contractual', 'Self-employed'], 'is_required' => 0, 'sort_order' => 18],
                ['question_text' => '16. Current position/designation', 'question_type' => 'text', 'options' => null, 'is_required' => 0, 'sort_order' => 19],
                ['question_text' => '17. Company/Organization name', 'question_type' => 'text', 'options' => null, 'is_required' => 0, 'sort_order' => 20],
