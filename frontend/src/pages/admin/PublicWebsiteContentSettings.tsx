...
export default function PublicWebsiteContentSettings() {
  ...
  const uploadAboutImages = async () => {
    ...
    for (const section of next) {
      ...
      section.image_path = String(data.file_path);
    }
    return next;
  };
